...
#include <imguifilesystem_TEST_MIGRATION.h>
...
void FileDialogGUI::onGUI(ImGuiContext* context)
{
	if (!applied) {
...
const char* FileDialogGUI::getType()
{
	return "EDITORGUI";
}

void FileDialogGUI::update(Input *input, std::chrono::microseconds delta) {}
